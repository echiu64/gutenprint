...
<H2><font color="#ff0000">Gutenprint 5.2.4-rc1 is released!</font></h2>

<P><strong><em><font color="#ff0000">New as of December 22,
2008!</strong></em></font> The Gutenprint project is pleased to
announce Gutenprint 5.2.4-rc1, a release candidate of 5.2.4.  This
release offers several fixes, new features, and support for new
printers for 5.2.3.  This package is available in source form, and in
binary installer form for Macintosh OS X (10.3 and above).  <a
