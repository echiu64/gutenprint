...
<P><strong><em><font color="#ff0000">New as of August 25, 2019!</strong></em></font>The Gutenprint project is pleased to announce Gutenprint 5.3.3.  This package is available in source form, and also in binary installer form for Macintosh OS X (10.6 or later, 64 bit only).  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.3/5.3.3/">You
can read the release notes and download it here</a>.  </p>

<H2><font color="#ff0000">Gutenprint 5.2.15 is available!</font></h2>

<P><strong><em><font color="#ff0000">New as of June 12, 2019!</strong></em></font>The Gutenprint project is pleased to announce Gutenprint 5.2.15, the last planned release of Gutenprint 5.2.  Future releases will be based on Gutenprint 5.3.  This release supports a few new printers, but is primarily to fix Macintosh OS X issues.  This package is available in source form, and also in binary installer form for Macintosh OS X (10.6 or later, 64 bit only).  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.15/">You
can read the release notes and download it here</a>.  </p>

<H2><font color="#ff0000">Gutenprint 5.3.1 is available!</font></h2>

<P><strong><em><font color="#ff0000">New as of September 22, 2018!</strong></em></font>The Gutenprint project is pleased to announce Gutenprint 5.3.0.  This is the first 5.3 release.  It includes a number of internal changes, including more precise positioning and sizing.  It may be installed alongside Gutenprint 5.2.  It also offers support additional printers; please consult the release notes for specifics.  It is currently available in source form.  A Macintosh installer package may be made available later; the Macintosh continues as a supported platform for Gutenprint.  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.3/5.3.1/">You
can read the release notes and download it here</a>.  </p>
...
<H2><font color="#ff0000">Gutenprint 5.2.13 is available!</font></h2>

<P><strong><em><font color="#ff0000">New as of July 17,
2017!</strong></em></font>The Gutenprint project is pleased to announce Gutenprint 5.2.13.  This release fixes some important bugs, adds support for additional printers, and offers improvements for others.  This package is available in source form, and also in binary installer form for Macintosh OS X.  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.13/">You
can read the release notes and download it here</a>.  </p>

<H2><font color="#ff0000">Gutenprint 5.2.12 is available!</font></h2>

<P><strong><em><font color="#ff0000">New as of January 19,
2017!</strong></em></font>The Gutenprint project is pleased to announce Gutenprint 5.2.12.  This release adds support for many new printers and other improvements over 5.2.11.  <b>Note that the Foomatic data generator and the Ghostscript IJS driver have been removed</b> as CUPS support is ubiquitous and Foomatic is not needed with CUPS.  This package is available in source form, and also in binary installer form for Macintosh OS X (10.6 and above; 10.5 and below are no longer supported).  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.12/">You
can read the release notes and download it here</a>.  </p>
...
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.11/">You
can read the release notes and download it here</a>.  </p>

<H2><font color="#ff0000">Gutenprint 5.2.10 is released!</font></h2>

<P><strong><em><font color="#ff0000">New as of May 20,
2014!</strong></em></font> After a very long hiatus, the Gutenprint project is pleased to announce Gutenprint 5.2.10, a stable release of 5.2.  This release adds support for many new printers and other improvements over 5.2.9.  The main impact is for developers that link against the Gutenprint library.  An updated German translation and improvement for some Epson and Canon media handling are also included. This package is available in source form, and also in binary installer form for Macintosh OS X (10.5 and above; 10.4 and below are no longer supported).  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.10/">You
can read the release notes and download it here</a>.  </p>
...
announce Gutenprint 5.2.8, a stable release of 5.2.  The Canon driver has been significantly overhauled for this release, and output (and in some cases functionality) may be significantly different from previous releases.  We expect to perform further work in future releases.  Also, an additional eighteen new Epson printers has been added. This package is available
in source form, and also in binary installer form
for Macintosh OS X (10.3 and above).  <a
href="https://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.8/">You
can read the release notes and download it here</a>.  </p>


<H2><font color="#ff0000">Gutenprint 5.2.7 is released!</font></h2>

<P><strong><em><font color="#ff0000">New as of May 2, 2011!</strong></em></font> The Gutenprint project is pleased to
announce Gutenprint 5.2.7, a stable release of 5.2.  This release offers support for more than 80 additional printers from Canon, Epson, and Kodak. There are also some changes for other Epson printers. This package is available
in source form, and also in binary installer form
for Macintosh OS X (10.3 and above).  <a
...
5.2.4.  This package is available in source form, and also in binary
...
5.2.3.  This package is available in source form, and in binary
installer form for Macintosh OS X (10.3 and above).  <a
href="http://sourceforge.net/project/showfiles.php?group_id=1537">You
can read the release notes and download it here</a>.  </p>

<H2><font color="#ff0000">Gutenprint 5.2.3 is released!</font></h2>

<P><strong><em><font color="#ff0000">New as of December 22,
2008!</strong></em></font> The Gutenprint project is pleased to
announce Gutenprint 5.2.3, a stable bugfix release of 5.2.  This
release offers several important fixes for 5.2.2.  This package is
available in source form, and in binary installer form for Macintosh
OS X (10.3 and above).  <a
href="http://sourceforge.net/project/showfiles.php?group_id=1537">You
can read the release notes and download it here</a>.  </p>

<H2><font color="#ff0000">Gutenprint 5.2.2 is released!</font></h2>

<P><strong><em><font color="#ff0000">New as of November 16,
2008!</strong></em></font> The Gutenprint project is pleased to
announce Gutenprint 5.2.2, a stable bugfix release of 5.2.  This
release offers a few bug fixes for 5.2.1.  This package is available
in source form, and in binary installer form for Macintosh OS X (10.3
and above).  <a
href="http://sourceforge.net/project/showfiles.php?group_id=1537">You
can read the release notes and download it here</a>.  </p>
