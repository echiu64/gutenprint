dnl @synopsis STP_CONFIG_LIBCONFIG_IN [(LIBRARY [, DESTINATION [, MODULES]])]
dnl
...
dnl STP_CONFIG_LIBCONFIG_IN_PKGCONFIG enables pkg-config support (default)
dnl STP_CONFIG_LIBCONFIG_IN_STATIC disables pkg-config support
dnl
...
echo 'fi' >>$LIBCONFIG_FILE
STP_CONFIG_LIBCONFIG_IN_MODULES(m4_if([$3], , [$1], [m4_translit([$1 $3], [ ], [,])]))dnl
...
# STP_CONFIG_LIBCONFIG_IN_MODULES [(MODULE1 [, MODULE2 [, ...]])]
# ---------------------------------------------------------------
#Output shell script using custom module variables.
AC_DEFUN([STP_CONFIG_LIBCONFIG_IN_MODULES],
[m4_if([$1], , ,
...
STP_CONFIG_LIBCONFIG_IN_MODULES_VARS([cflags], [MODULE_DOWN[]_cflags], [cflags])
STP_CONFIG_LIBCONFIG_IN_MODULES_VARS([libs], [MODULE_DOWN[]_libs], [libs])
STP_CONFIG_LIBCONFIG_IN_MODULES_VARS([version], [MODULE_UP[]_VERSION], [modversion])
echo 'fi' >>$LIBCONFIG_FILE
m4_popdef([MODULE_UP])dnl
m4_popdef([MODULE_DOWN])dnl
STP_CONFIG_LIBCONFIG_IN_MODULES(m4_shift($@))])dnl
])


# STP_CONFIG_LIBCONFIG_IN_MODULES_VARS [(VAR, SUBSTITUTION,
# PKGCONFIG_ARGS)]
# ---------------------------------------------------------
# Output STP_CONFIG_LIBCONFIG_IN_MODULES variables.
#   VAR = variable to set
...
# STP_CONFIG_LIBCONFIG_IN_PKGCONFIG
# ---------------------------------
# Enable pkgconfig support in libconfig script (default)
AC_DEFUN([STP_CONFIG_LIBCONFIG_IN_PKGCONFIG],
[m4_define([STP_CONFIG_LIBCONFIG_IN_USEPKGCONFIG], [true])
])dnl


# STP_CONFIG_LIBCONFIG_IN_STATIC
# ------------------------------
# Disable pkgconfig support in libconfig script
AC_DEFUN([STP_CONFIG_LIBCONFIG_IN_STATIC],
[m4_define([STP_CONFIG_LIBCONFIG_IN_USEPKGCONFIG], [false])
])dnl
