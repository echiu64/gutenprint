...
<body style="background-color:#FFFFFF;color:#000000;font-family:Arial,sans-serif;margin-right:1%;margin-left:1%;">
<!--  Top gray bar -->
...
<table border="0">
	<tr>
		<td>
			<img src="images/top_image.png" width="544" height="111" alt="Welcome to the Gutenprint Website [46.51 KB]" border="0">
		</td>
		<td>
			<p>
				<a href="http://sourceforge.net/project/memberlist.php?group_id=1537">Meet the Developers!</a>
				<br>
...
<table border="0" width="100%" cellspacing="0">
	<tr>
		...
		<td bgcolor="#eeeeee">
			<p>
				<font color="#d0d0d0">Welcome to Gutenprint!</font>
			</p>
		</td>
	</tr>
</table>
...
<!-- indent text -->
	<div style="margin-right:1em;margin-left:1em;">
		...
		<p>
			...
			<br>
			<a href="MacOSX.php#5.3.3">August 25, 2019</a> - The Gutenprint project is pleased to announce Gutenprint 5.3.3, the first stable release of Gutenprint 5.3.  This package is 64-bit only.<b>NOTE: Users of many dye sublimation printers must follow a special installation procedure.  Please read the release notes very carefully!</b>  See the <a href="MacOSX.php#5.3.3">Release notes</a> for more detail.  See the <b>Downloads</b> section for download links.
		</p>
		<p>
...
<!-- right column -->
<!-- margin-left of 52% centers things nicely as columns are 48% width -->
<div style="text-align:left; width:48%; background-color:#eeeeee;margin-left:52%;margin-top:2em;">
<!-- indent text -->
	<div style="margin-right:1em;margin-left:1em;">
		<h2> Downloads</h2>
		<p>
			<b>Gutenprint 5.3.3</b>
			<br>
			<span style="background-color:#d0ffff;"><a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.3/5.3.3/gutenprint-5.3.3.dmg/download">gutenprint-5.3.3.dmg</a></span>&nbsp;&nbsp;(6.1 MB)
		</p>
		<p>
The Gutenprint project is pleased to announce Gutenprint 5.3.3, the first stable release of Gutenprint 5.3.  The package is 64-bit only and requires 10.6 (Snow Leopard) or higher.&nbsp;&nbsp;(<a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.3/5.3.3/gutenprint-5.3.3.tar.bz2/download">source code</a>)
</p>
		<p>
			<b>Gutenprint 5.2.15</b>
			<br>
			<span style="background-color:#d0ffff;"><a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.15/gutenprint-5.2.15.dmg/download">gutenprint-5.2.15.dmg</a></span>&nbsp;&nbsp;(6.1 MB)
		</p>
		<p>
The Gutenprint project is pleased to announce Gutenprint 5.2.15, the last planned release of Gutenprint 5.2.  Future releases will be based on Gutenprint 5.3.  The package is now 64-bit only, and requires 10.6 (Snow Leopard) or higher.&nbsp;&nbsp;(<a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.15/gutenprint-5.2.15.tar.bz2/download">source code</a>)
</p>

		<p>
			<b>Gutenprint 5.2.14</b>
			<br>
			<span style="background-color:#d0ffff;"><a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.14/gutenprint-5.2.14.dmg/download">gutenprint-5.2.14.dmg</a></span>&nbsp;&nbsp;(12.4 MB)
		</p>
		<p>
...
The Gutenprint project is pleased to announce Gutenprint 5.2.11, a stable release of 5.2. Gutenprint 5.2.11 provides full support for Macintosh OS X 10.11 (El Capitan).  It no longer supports Macintosh OS X 10.5 or below; it now requires 10.6 (Snow Leopard) or higher.&nbsp;&nbsp;(<a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.11/gutenprint-5.2.11.tar.bz2/download">source code</a>)
		...
		<p>
			...
			<br>
			<span style="background-color:#d0ffff;"><a href="http://sourceforge.net/projects/gimp-print/files/gutenprint-5.2/5.2.10/gutenprint-5.2.10a.dmg/download">gutenprint-5.2.10a.dmg</a></span>&nbsp;&nbsp;(12.4 MB)
		</p>
		<p>
...
<!-- deleted older release info as iCab was still displaying it -->
		...
		<hr>
		<p>
			<b>Gutenprint Uninstaller <br>updated for El Capitan (OS X10.11)</b>
			<br>
			<span style="background-color:#d0ffff;"><a href="http://sourceforge.net/projects/gimp-print/files/Uninstaller%20-%20Mac%20OS%20X%20ONLY/2.0/uninstall-gutenprint-2.0.zip/download">uninstall-gutenprint</a></span>&nbsp;&nbsp;(109 KB)
		</p>
		<p>
			The updated uninstaller will work on any system OS X 10.2.x through at least 10.11.</p>
			<p>The Gutenprint uninstaller will completely remove any version of Gutenprint/Gimp-Print that was installed with an official Mac OS X installer package provided by the Gimp-Print project. It will also remove the version of Gutenprint/Gimp-Print that is included on any Apple OS X install disk.
		</p>
		<p>
...
<!-- Reset to one column again.  This will make sure the text flows below the longer column. -->
...
<p>
<b>Gutenprint 5.3.3</b> is the first stable release of Gutenprint 5.3.  This package is 64-bit only.  <b>NOTE: Users of many dye sublimation printers must follow a special installation procedure.  Please read the release notes very carefully!</b>
<ol style="margin-top:0.25em; list-style-type:decimal;">

	<li> First stable release of Gutenprint 5.3.3</li>

	<li> Please see the release notes for full details.</li>
</ol>
</p>
<a name="5.2.15"></a>
<table cellpadding="0" bgcolor="#d0d0d0" width="60%">
...
<p>
<b>Gutenprint 5.2.15</b> is the last planned release of Gutenprint 5.2; future releases will be based on 5.3.  This release fixes a problem with dye sublimation printers not functioning, restores the uninstaller, and should fix some other issues on OS X.  As of this release, this package is 64-bit only.  <b>NOTE: Users of many dye sublimation printers must follow a special installation procedure.  Please read the release notes very carefully!</b>
<ol style="margin-top:0.25em; list-style-type:decimal;">
...
<p>
<b>Gutenprint 5.2.14</b> is a stable release of Gutenprint 5.2.  This release adds full color support for most color laser printers, fixes some important bugs, adds support for additional printers, and offers improvements for others.  <b>NOTE: Users of many dye sublimation printers must follow a special installation procedure.  Please read the release notes very carefully!</b>
<ol style="margin-top:0.25em; list-style-type:decimal;">

	<li> Full color support for color laser printers</li>
...
<ol style="margin-top:0.25em; list-style-type:decimal;">
	...
	<li> Add support and improvements for additional dye sublimation printers</li>
...
<p>
<b>Gutenprint 5.2.11</b> is a stable release of Gutenprint 5.2.  This release adds support for many new printers (including the initial introduction of support for Datamax-O'Neil label printers, dye sublimation and Canon inkjet printers and other improvements over 5.2.10. <b>NOTE: Users of many dye sublimation printers must follow a special installation procedure.  Please read the release notes very carefully!</b>
<ol style="margin-top:0.25em; list-style-type:decimal;">
...
<p>
<b>Gutenprint 5.2.9</b> is a stable release of Gutenprint 5.2  This release fixes a several bugs from 5.2.8.  The main impact is for developers that link against the Gutenprint library.
<ol style="margin-top:0.25em; list-style-type:decimal;">
	<li>This release fixes an inappropriate change to the internal library version number (.soname or equivalent) made in 5.2.8. All distributors should immediately apply this update to their distributions to avoid other software linking against libgutenprint breaking.</li>

	<li>  Duplicate Transparency entries in the media types for Canon iP4100 and similar printers have been removed.</li>

	<li> The range of fine position adjustment of CD media has been increased for Epson printers.</li>

	<li>   The German translation has been updated.</li>

	<li>  Canon PIXMA Pro9000 plain media high quality mode bug fix.</li>
</ol>
</p>
...
<p>
<b>Gutenprint 5.2.4-rc1</b> is a release candidate from the stable branch of Gutenprint 5.2.  Gutenprint 5.2 no longer supports Macintosh OS X 10.2; it now requires 10.3 (Panther) or higher. Notable changes since the Gutenprint 5.2.3:</p>
...
<ul style="list-style: disc;">
	<li>A bug involving excessive memory consumption in certain cases has been fixed.  Printing multiple page documents on Canon inkjet printers with the Duplex option set to Long Edge resulted in very large memory consumption on alternate pages, which was not released until the job completed.</li>
...
<li>A new dither algorithm, Ordered New, has been added.  This dither algorithm is most likely to improve output at low resolutions, particularly when printing black and white.  It will only help on printers offering multiple drop sizes.</li>
<li>The color correction for the Canon PIXMA iP4200 has been improved.</li>
<li>The PPD file parsing code in the Postscript driver has been rewritten.  Gutenprint may now be used with any code licensed as GPL v2 or any later version of the GPL.
</li>
...
<table cellpadding="0" bgcolor="#d0d0d0" width="60%">
	<tr>
		<td align="left">
			<b>Gutenprint 5.0.2-beta1</b> (5.0.1.98.1)
		</td>
		<td align="right">
			<b>2007-12-17</b>
		</td>
...
<ul>
	...
	<li>The stable branch (5.0.x) retains support for HP Business Inkjet, DeskJet, Photosmart, OfficeJet, and Color LaserJet printers that has been dropped from the developmental branch.
	</li>
</ul>
 <p>
Additional information can be found in the <a href="http://sourceforge.net/project/shownotes.php?group_id=1537&amp;release_id=562136">release notes</a>.
</p>
...
<p>
	Please note that as of 5.0.0-beta1 the behavior of the Mac OS X installer has changed. The installer will now permit Gimp-Print 4.2.x and Gimp-Print 5.0 to be installed simultaneously, so that printer queues may be created using either driver. If you do not wish to retain your existing installation of Gimp-Print 4.2.x simply click on the <strong>Customize</strong> button available on the last screen of the installer and check the box for &quot;Gimp-Print 4.2.x Uninstaller&quot;
</p>
<p>
...
<ol>
	<li>
		...
		<br>
		<br>
		<b> We have released a replacement USB backend driver for Macintosh OS X 10.2 and higher that to the best of our knowledge fixes all of these problems. This driver, named "usbtb", is available on the <a href="http://sourceforge.net/project/showfiles.php?group_id=1537&amp;package_id=120183">project download site</a> and more information about usbtb is available <a href="http://www.buymelunch.org/printing/usbtb/">here</a>. We recommend that all users of OS X 10.2 and above who are having printing problems with USB-attached printers try this driver. </b> In addition to resolving these problems, this driver also also provides textual cues to the system printer queue window to walk the user through recovery from common error conditions, and it also provides ink level reporting for Epson and HP printers that support it.
		<br>
		<br>
...
<hr>
<h2> The History of Gimp-Print </h2> <h3>The early years: Gimp-Print 3.x and 4.0</h3>
<p>
...
<table border="0" align="right">
	<tr>
		<td>
			<a href="http://sourceforge.net"><img src="http://sourceforge.net/sflogo.php?group_id=1537&amp;type=5" width="210" height="63" border="0" alt="SourceForge Logo"></a>
		</td>
		<td>
			<p>
				Resources very kindly
				<br>
				provided by <a href="http://sourceforge.net">SourceForge.</a>
			</p>
		</td>
	</tr>
</table>
