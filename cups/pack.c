 ...
 * "$Id$"
 *
 *   Packing functions for the CUPS driver development kit.
 *
 ...
 * Contents:
 *
 *   PackHorizontal()    - Pack pixels horizontally...
 *   PackHorizontal2()   - Pack 2-bit pixels horizontally...
 *   PackHorizontalBit() - Pack pixels horizontally by bit...
 *   PackVertical()      - Pack pixels vertically...
 */
...
void
PackHorizontal(const unsigned char *ipixels,	/* I - Input pixels */
...
void
PackHorizontal2(const unsigned char *ipixels,	/* I - Input pixels */
        	unsigned char       *obytes,	/* O - Output bytes */
        	int                 width,	/* I - Number of pixels */
...
void
PackHorizontalBit(const unsigned char *ipixels,	/* I - Input pixels */
                  unsigned char       *obytes,	/* O - Output bytes */
                  int                 width,	/* I - Number of pixels */
                  const unsigned char clearto,	/* I - Initial value of bytes */
...
void
PackVertical(const unsigned char *ipixels,	/* I - Input pixels */
             unsigned char       *obytes,	/* O - Output bytes */
