...
/* Y */  "0.00 0.00 -.01 -.07 -.13 -.19 -.22 -.24 "  /* G */
...
/* R */  "-.22 -.14 -.08 -.06 -.04 -.02 0.00 0.00 "  /* Y */
...
static const paper_adjustment_t sp960_adjustments[] =
{
  ...
  { "Postcard", 0.90, .5, 0.5, .1, .9, .9, 1, 1, 1, 1, 1,
    sp960_matte_hue_adj, sp960_matte_lum_adj, sp960_matte_sat_adj },
  { "GlossyFilm", 1.00, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Transparency", 1.00, .6, 0.5, .1, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Envelope", 0.860, .5, 0.5, .1, .9, 1, 1, 1, 1, 1, 1,
    sp960_matte_hue_adj, sp960_matte_lum_adj, sp960_matte_sat_adj },
  { "BackFilm", 1.00, .6, 0.5, .1, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Matte", 1.00, 0.7, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_matte_hue_adj, sp960_matte_lum_adj, sp960_matte_sat_adj },
  { "MatteHeavy", 1.00, .75, 0.5, .25, .9, 1, 1, 1, 1, 1, 1,
    sp960_matte_hue_adj, sp960_matte_lum_adj, sp960_matte_sat_adj },
  { "Inkjet", 0.9, .5, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_matte_hue_adj, sp960_matte_lum_adj, sp960_matte_sat_adj },
  { "Coated", .9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Photo", 0.9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "GlossyPhoto", 0.9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Semigloss", 0.9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Luster", 0.9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "GlossyPaper", .9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
  { "Ilford", .85, .75, 0.5, .15, 1.35, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj  },
  { "ColorLife", .9, .75, 0.5, .15, .9, 1, 1, 1, 1, 1, 1,
    sp960_hue_adj, sp960_lum_adj, sp960_sat_adj },
