...
static const canon_mode_t canon_MULTIPASS_MP150_modes[] = {
  ...
  /*  {  600, 600,CANON_INK_CMY,"600x600dpi_photohigh",N_("600x600 DPI PHOTO HIGH"),INKSET(13_c9m9y9),8,MODE_FLAG_EXTENDED_T,NULL|MODE_FLAG_COLOR,1.0,1.0,NULL,NULL,NULL,3}, */ /* cmy: subtract 0x60 */
