...
static const canon_mode_t canon_PIXMA_iP4200_modes[] = {
  ...
  /* Hagaki, Env: K & k */
  {  600, 600,CANON_INK_CcMmYKk,"600x600dpi_high2",N_("600x600 DPI HIGH (Env/Hagaki)"),INKSET(22_C3M3Y2K2k3on_c),16,MODE_FLAG_EXTENDED_T,NULL,1.0,1.0,NULL,NULL,NULL,3},
