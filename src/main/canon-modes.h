...
static const canon_mode_t canon_MULTIPASS_MP360_modes[] = {
  ...
  /* photo modes: make sure  cmy is output to commented-out modes */
  /* inkjet Hagaki use same modes as other photo media */
  /*  {  600, 600,CANON_INK_CcMmYyK,"600x600dpi_photohigh2",N_("600x600 DPI PHOTO HIGHEST (Pro)"),INKSET(9_C4M4Y4K2c4m4y4),8,MODE_FLAG_EXTENDED_T,NULL,1.0,1.0,NULL,NULL,NULL,4},*/
  ...
  /* OHP */
  {  600, 600,CANON_INK_CcMmYyK,"600x600dpi_ohphigh",N_("600x600 DPI HIGH OHP"),INKSET(9_C4M4Y4K3),16,MODE_FLAG_EXTENDED_T|MODE_FLAG_MP360,NULL,1.0,1.0,NULL,NULL,NULL,3},
  {  600, 600,CANON_INK_CMYK | CANON_INK_K,"600x600dpi_ohp",N_("600x600 DPI STD OHP"),INKSET(9_C3M3Y2K2),16,MODE_FLAG_EXTENDED_T,NULL,1.0,1.0,NULL,NULL,NULL,1},
  /* T-shirt */
