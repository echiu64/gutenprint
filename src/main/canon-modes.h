...
static const canon_mode_t canon_PIXMA_iP1000_modes[] = {
  ...
  {  300, 300,CANON_INK_CMYK,"300x300dpi_draft",N_("300x300 DPI DRAFT"),INKSET(9_C2M2Y2K2),MODE_FLAG_EXTENDED_T,NULL,1.0,1.0,NULL,NULL,NULL,1},
...
DECLARE_MODES(canon_PIXMA_iP1000,0);
