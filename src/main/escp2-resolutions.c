...
const res_t stpi_escp2_720dpi_reslist[] =
{
  { "360x90dpi",        N_("360 x 90 DPI Fast Economy Draft"),
    360,  90,   360,  90,   0,  0, 1, 1, 1, 1, RES_LOW },

  { "360x120dpi",       N_("360 x 120 DPI Economy Draft"),
    360,  120,  360,  120,  0,  0, 1, 1, 3, 1, RES_LOW },

  { "180dpi",           N_("180 DPI Economy Draft"),
    180,  180,  180,  180,  0,  0, 1, 1, 1, 1, RES_LOW },

  { "360x240dpi",       N_("360 x 240 DPI Draft"),
    360,  240,  360,  240,  0,  0, 1, 1, 3, 2, RES_LOW },

  { "360x180dpi",       N_("360 x 180 DPI Draft"),
    360,  180,  360,  180,  0,  0, 1, 1, 1, 1, RES_LOW },

  { "360mw",            N_("360 DPI Microweave"),
    360,  360,  360,  360,  0,  1, 1, 1, 1, 1, RES_360 },
  { "360dpi",           N_("360 DPI"),
    360,  360,  360,  360,  0,  0, 1, 1, 1, 1, RES_360 },

  { "720x360sw",        N_("720 x 360 DPI"),
    720,  360,  720,  360,  1,  0, 1, 1, 2, 1, RES_720_360 },

  { "720mw",            N_("720 DPI Microweave"),
    720,  720,  720,  720,  0,  1, 1, 1, 1, 1, RES_720 },
...
const res_t stpi_escp2_1440dpi_reslist[] =
{
  { "360x90sw",         N_("360 x 90 DPI Fast Economy Draft"),
    360,  90,   360,  90,   1,  0, 1, 1, 1, 1, RES_LOW },

  { "360x120sw",        N_("360 x 120 DPI Economy Draft"),
    360,  120,  360,  120,  1,  0, 1, 1, 3, 1, RES_LOW },

  { "180sw",            N_("180 DPI Economy Draft"),
    180,  180,  180,  180,  1,  0, 1, 1, 1, 1, RES_LOW },

  { "360x240sw",        N_("360 x 240 DPI Draft"),
    360,  240,  360,  240,  1,  0, 1, 1, 3, 2, RES_LOW },

  { "360x180sw",        N_("360 x 180 DPI Draft"),
    360,  180,  360,  180,  1,  0, 1, 1, 1, 1, RES_LOW },
...
const res_t stpi_escp2_standard_reslist[] =
{
  ...
  { "1440x1440sw",      N_("1440 x 1440 DPI"),
    1440, 1440, 1440, 1440, 1,  0, 1, 1, 1, 1, RES_2880_720},
  { "1440x1440hq2",     N_("1440 x 1440 DPI Highest Quality"),
    1440, 1440, 1440, 1440, 1,  0, 2, 1, 1, 1, RES_2880_720},
...
const res_t stpi_escp2_pro_reslist[] =
{
  ...
  { "360fol",           N_("360 DPI Full Overlap"),
    360,  360,  360,  360,  0,  2, 1, 1, 1, 1, RES_360 },
  { "360fol2",          N_("360 DPI FOL2"),
    360,  360,  360,  360,  0,  4, 1, 1, 1, 1, RES_360 },
  { "360mw2",           N_("360 DPI MW2"),
    360,  360,  360,  360,  0,  5, 1, 1, 1, 1, RES_360 },

  { "720x360dpi",       N_("720 x 360 DPI"),
    720,  360,  720,  360,  0,  0, 1, 1, 2, 1, RES_720_360 },
  { "720x360mw",        N_("720 x 360 DPI Microweave"),
    720,  360,  720,  360,  0,  1, 1, 1, 2, 1, RES_720_360 },
  { "720x360fol",       N_("720 x 360 DPI FOL"),
    720,  360,  720,  360,  0,  2, 1, 1, 2, 1, RES_720_360 },
  { "720x360fol2",      N_("720 x 360 DPI FOL2"),
    720,  360,  720,  360,  0,  4, 1, 1, 2, 1, RES_720_360 },
  { "720x360mw2",       N_("720 x 360 DPI MW2"),
    720,  360,  720,  360,  0,  5, 1, 1, 2, 1, RES_720_360 },

  { "720mw",            N_("720 DPI Microweave"),
    720,  720,  720,  720,  0,  1, 1, 1, 1, 1, RES_720 },
  { "720fol",           N_("720 DPI Full Overlap"),
    720,  720,  720,  720,  0,  2, 1, 1, 1, 1, RES_720 },
  { "720fourp",         N_("720 DPI Four Pass"),
    720,  720,  720,  720,  0,  3, 1, 1, 1, 1, RES_720 },

  { "1440x720mw",       N_("1440 x 720 DPI Microweave"),
    1440, 720,  1440, 720,  0,  1, 1, 1, 1, 1, RES_1440_720 },
  { "1440x720fol",      N_("1440 x 720 DPI FOL"),
    1440, 720,  1440, 720,  0,  2, 1, 1, 1, 1, RES_1440_720 },
  { "1440x720fourp",    N_("1440 x 720 DPI Four Pass"),
    1440, 720,  1440, 720,  0,  3, 1, 1, 1, 1, RES_1440_720 },

  { "2880x720mw",       N_("2880 x 720 DPI Microweave"),
    2880, 720,  2880, 720,  0,  1, 1, 1, 1, 1, RES_2880_720 },
  { "2880x720fol",      N_("2880 x 720 DPI FOL"),
    2880, 720,  2880, 720,  0,  2, 1, 1, 1, 1, RES_2880_720 },
  { "2880x720fourp",    N_("2880 x 720 DPI Four Pass"),
    2880, 720,  2880, 720,  0,  3, 1, 1, 1, 1, RES_2880_720 },

  { "1440x1440mw",       N_("1440 x 1440 DPI Microweave"),
    1440, 1440,  1440, 1440,  0,  1, 1, 1, 1, 1, RES_2880_720 },
  { "1440x1440fol",      N_("1440 x 1440 DPI FOL"),
    1440, 1440,  1440, 1440,  0,  2, 1, 1, 1, 1, RES_2880_720 },
  { "1440x1440fourp",    N_("1440 x 1440 DPI Four Pass"),
    1440, 1440,  1440, 1440,  0,  3, 1, 1, 1, 1, RES_2880_720 },

  { "2880x1440mw",       N_("2880 x 1440 DPI Microweave"),
    2880, 1440,  2880, 1440,  0,  1, 1, 1, 1, 1, RES_2880_1440 },
  { "2880x1440fol",      N_("2880 x 1440 DPI FOL"),
    2880, 1440,  2880, 1440,  0,  2, 1, 1, 1, 1, RES_2880_1440 },
  { "2880x1440fourp",    N_("2880 x 1440 DPI Four Pass"),
    2880, 1440,  2880, 1440,  0,  3, 1, 1, 1, 1, RES_2880_1440 },
