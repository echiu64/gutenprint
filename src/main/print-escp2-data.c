...
{ 3.0, 1.5,  0.75, 0.750, 0.750, 0.750, 0.0,   0.0,  };
...
const stpi_escp2_printer_t stpi_escp2_model_capabilities[] =
{
  ...
  /* 0: Stylus Color */
  {
    ...
    9, 9, 9, 40, 9, 9, 9, 40, 9, 9, 0, 0, 9, 9, 0, 0, -1, -1,
    1, 7, 0, 0,
  ...
  /* 3: Stylus Color 600 */
  {
    ...
    INCH(17 / 2), INCH(44), INCH(2), INCH(2),
    8, 9, 0, 30, 8, 9, 0, 30, 8, 9, 0, 0, 8, 9, 0, 0, -1, -1,
    1, 7, 0, 0,
  ...
  /* 4: Stylus Color 800 */
  {
    ...
    INCH(17 / 2), INCH(44), INCH(2), INCH(2),
    8, 9, 9, 40, 8, 9, 9, 40, 8, 9, 0, 0, 8, 9, 0, 0, -1, -1,
    1, 7, 0, 0,
  ...
  /* 7: Stylus Photo 700 */
  {
    ...
    360, 14400, -1, 1440, 720, 90, 90, 0, 1, 0, 0, 0, 0, 8,
    INCH(17 / 2), INCH(44), INCH(2), INCH(2),
    9, 9, 0, 30, 9, 9, 0, 30, 9, 9, 0, 0, 9, 9, 0, 0, -1, -1,
    1, 7, 0, 0,
  ...
  /* 10: Stylus Color 440/460 */
  {
    ...
    360, 14400, -1, 720, 720, 90, 90, 0, 1, 0, 0, 0, 0, 8,
    INCH(17 / 2), INCH(44), INCH(2), INCH(2),
    9, 9, 0, 9, 9, 9, 0, 9, 9, 9, 0, 0, 9, 9, 0, 0, -1, -1,
    1, 15, 0, 0,
  ...
  /* 18: Stylus Color 660 */
  {
    ...
    360, 14400, -1, 1440, 720, 90, 90, 0, 1, 0, 0, 0, 0, 8,
    INCH(17 / 2), INCH(44), INCH(2), INCH(2),
    9, 9, 9, 9, 9, 9, 9, 26, 9, 9, 9, 0, 9, 9, 9, 0, -1, -1,
    1, 15, 0, 0,
  ...
  /* 28: Stylus Pro 7000 */
  {
    ...
    9, 9, 9, 40, 9, 9, 9, 40, 9, 9, 9, 9, 9, 9, 9, 9, -1, -1,
    1, 7, 0, 0,
  ...
  /* 32: Stylus Color 777/680 */
  {
    ...
    INCH(17 / 2), INCH(1200), INCH(2), INCH(2),
    9, 9, 0, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 0, 0, -1, -1,
    3, 15, 0, 0,
  ...
  /* 35: Stylus Photo 780/790/810/820 */
  {
    ...
    INCH(17 / 2), INCH(1200), INCH(2), INCH(2),
    9, 9, 0, 0, 9, 9, 0, 0, 9, 9, 0, 0, 9, 9, 0, 0, -1, -1,
    3, 15, 0, 0,
    c4pl_dotsizes, c4pl_densities, &stpi_escp2_variable_4pl_drops,
  ...
  /* 47: Stylus Photo 2100/2200 */
  {
    ...
    360, 14400, -1, 2880, 1440, 360, 180, 0, 1, 0, 190, 0, 0, 0,
    INCH(13), INCH(1200), INCH(2), INCH(2),
    9, 9, 0, 9, 9, 9, 0, 9, 9, 9, 0, 0, 9, 9, 0, 0, 204, 191,
    4, 15, 0, 0,
