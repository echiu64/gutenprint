...
/* 5-level decompression table for 4-bit inks */
static const unsigned short Table5Level[] = {
  ...
  0x422,0x423,0x424,0x430,0x431,0x432,0x433,0x434,0x440,0x441,0x442,0x443,0x444,0x0,0x0,0x0 /*fill to 16 entries, why I don't know*/
};

/* 6-level decompression table for 4-bit inks */
static const unsigned short Table6Level[] = {
  ...
  0x544,0x545,0x550,0x551,0x552,0x553,0x554,0x555,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 /*fill to 16 entries, why I don't know*/
};
